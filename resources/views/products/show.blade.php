...
@section('content')
	...
	<h3>
		<b> Image 2 </b> <br>
		<img src='/uploads/{{ $product->image2}}' height="200" width="200">
	</h3>
	<h3> 
		<b> Image 3 </b> <br>
		<img src='/uploads/{{ $product->image3}}' height="200" width="200">
	</h3>
	<h3>
		<b> Featured Image </b>	::<br>
		<img src='/uploads/{{ $product->featured_image}}' height="200" width="200">
	</h3>
